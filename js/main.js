...
const totalIncomeAmount = document.getElementById("total_income_amount");
const totalExpenseAmount = document.getElementById("total_expense_amount");
...
const getAllData = async () => {
  try {
    ...
    totalExpenseAmount.textContent = `-${totalExpense}$`;
    totalAmount.textContent = `${netTotal}$`;
